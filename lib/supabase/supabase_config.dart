...
/// PulpitFlow Supabase configuration
/// Handles database operations for khutbah content, templates, and user data
class SupabaseConfig {
  static const String supabaseUrl = 'https://jslerlyixschpaefyaft.supabase.co';
  static const String anonKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImpzbGVybHlpeHNjaHBhZWZ5YWZ0Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTU5NTcwODUsImV4cCI6MjA3MTUzMzA4NX0.Wm1Eolk-HysrZ5PerTiu_1NMj7JYJidFdav1c6VvpIk';
...
/// Authentication service for PulpitFlow users
class SupabaseAuth {
